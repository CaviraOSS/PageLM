...
export const config = {
  ...
  requesty_model: process.env.REQUESTY_MODEL || 'openai/gpt-4o-mini',
  requesty_embed_model: process.env.REQUESTY_EMBED_MODEL || 'openai/text-embedding-3-large',
  requesty_base: process.env.REQUESTY_BASE_URL || 'https://router.requesty.ai/v1',
  ...
  voxcpm_api_key: process.env.VOXCPM_API_KEY || '',
  voxcpm_model: process.env.VOXCPM_MODEL || 'VoxCPM2',
  voxcpm_base_url: process.env.VOXCPM_BASE_URL || 'https://api.modelbest.cn/v1',
